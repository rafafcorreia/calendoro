    ...
    setLang(calendario) {
        switch (calendario.configs.lang) {
            case 'es':
                ...
                $('#weekdays').children().eq(0).text('Domingo');
                $('#weekdays').children().eq(1).text('Lunes');
                $('#weekdays').children().eq(2).text('Martes');
                $('#weekdays').children().eq(3).text('Miércoles');
                $('#weekdays').children().eq(4).text('Jueves');
                $('#weekdays').children().eq(5).text('Viernes');
                $('#weekdays').children().eq(6).text('Sábado');
            ...
            case 'en':
                ...
                $('#weekdays').children().eq(0).text('Sunday');
                $('#weekdays').children().eq(1).text('Monday');
                $('#weekdays').children().eq(2).text('Tuesday');
                $('#weekdays').children().eq(3).text('Wednesday');
                $('#weekdays').children().eq(4).text('Thursday');
                $('#weekdays').children().eq(5).text('Friday');
                $('#weekdays').children().eq(6).text('Saturday');
            ...
            case 'pt':
                ...
                $('#weekdays').children().eq(0).text('Domingo');
                $('#weekdays').children().eq(1).text('Segunda');
                $('#weekdays').children().eq(2).text('Terça');
                $('#weekdays').children().eq(3).text('Quarta');
                $('#weekdays').children().eq(4).text('Quinta');
                $('#weekdays').children().eq(5).text('Sexta');
                $('#weekdays').children().eq(6).text('Sábado');
